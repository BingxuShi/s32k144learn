...
#include "Ftm_Pwm_Ip_BOARD_InitPeripherals_PBcfg.h"
...
/* Check if header file and Ftm_Pwm_Ip_BOARD_InitPeripherals_Pbcfg header file are of the same vendor */
#if (FTM_PWM_IP_CFG_VENDOR_ID != FTM_PWM_IP_BOARD_InitPeripherals_PB_CFG_VENDOR_ID)
    #error "Vendor IDs of Ftm_Pwm_Ip_Cfg.h and Ftm_Pwm_Ip_BOARD_InitPeripherals_Pbcfg.h are different."
#endif

/* Check if header file and Pwm_EnvCfg header file are of the same AUTOSAR version */
#if ((FTM_PWM_IP_CFG_AR_RELEASE_MAJOR_VERSION    != FTM_PWM_IP_BOARD_InitPeripherals_PB_CFG_AR_RELEASE_MAJOR_VERSION) || \
     (FTM_PWM_IP_CFG_AR_RELEASE_MINOR_VERSION    != FTM_PWM_IP_BOARD_InitPeripherals_PB_CFG_AR_RELEASE_MINOR_VERSION) || \
     (FTM_PWM_IP_CFG_AR_RELEASE_REVISION_VERSION != FTM_PWM_IP_BOARD_InitPeripherals_PB_CFG_AR_RELEASE_REVISION_VERSION))
    #error "AUTOSAR version numbers of Ftm_Pwm_Ip_Cfg.h and Ftm_Pwm_Ip_BOARD_InitPeripherals_Pbcfg.h are different."
#endif

/* Check if header file and Pwm_EnvCfg header file are of the same software version */
#if ((FTM_PWM_IP_CFG_SW_MAJOR_VERSION != FTM_PWM_IP_BOARD_InitPeripherals_PB_CFG_SW_MAJOR_VERSION) || \
     (FTM_PWM_IP_CFG_SW_MINOR_VERSION != FTM_PWM_IP_BOARD_InitPeripherals_PB_CFG_SW_MINOR_VERSION) || \
     (FTM_PWM_IP_CFG_SW_PATCH_VERSION != FTM_PWM_IP_BOARD_InitPeripherals_PB_CFG_SW_PATCH_VERSION))
    #error "Software version numbers of Ftm_Pwm_Ip_Cfg.h and Ftm_Pwm_Ip_BOARD_InitPeripherals_Pbcfg.h are different."
#endif
...
#define FTM_PWM_SIM_INSTANCE_COUNT                  (SIM_INSTANCE_COUNT)

#if ((STD_ON == FTM_PWM_IP_ENABLE_USER_MODE_SUPPORT) && defined(MCAL_FTM_REG_PROT_AVAILABLE) && (STD_ON == MCAL_FTM_REG_PROT_AVAILABLE))
...
#define FTM_PWM_CHANNEL_COUNT                       (FTM_CONTROLS_COUNT)
#define FTM_PWM_PAIR_COUNT                          (FTM_CONTROLS_COUNT >> 1U)

/** Number of interrupt vector arrays for the FTM module. */
#define FTM_PWM_IRQS_ARR_COUNT                      (FTM_INSTANCE_COUNT)
/** Number of interrupt channels for the FTM module. */
#define FTM_PWM_CHANNEL_IRQ_COUNT                   (FTM_CONTROLS_COUNT)
...
#define FTM_PWM_Overflow_IRQS                       { FTM0_IRQn, FTM1_IRQn }
#define FTM_PWM_Reload_IRQS                         { FTM0_IRQn, FTM1_IRQn }

/* Mask for Software Output Control Value of all channel bits */
#define FTM_PWM_SWOCTRL_CHnOC_MASK                  (0x000000FFU)
/* Mask for Software Output Control Value of all channel bits */
#define FTM_PWM_SWOCTRL_CHnOCV_MASK                 (0x0000FF00U)

/* @brief Width of control channel */
#define FTM_PWM_COMBINE_CHAN_CTRL_WIDTH             (8U)


#define FTM_FAULT_NUMBER_CHANNELS                  (4U)
/*==================================================================================================
