...
undefined_handler/4 (undefined_handler) @061a0d20
  Type: function
  ...
  Called by: 
  Calls: 
intRouteConfig/3 (intRouteConfig) @0619fc18
...
aIrqRouteConfig/2 (aIrqRouteConfig) @0619fbd0
  Type: variable definition analyzed
  ...
  Availability: available
  Varpool flags: initialized read-only const-value-known
IntCtrlConfig_0/1 (IntCtrlConfig_0) @0619faf8
  Type: variable definition analyzed
  Visibility: externally_visible public
  ...
  Availability: available
  Varpool flags: initialized read-only const-value-known
aIrqConfiguration1/0 (aIrqConfiguration1) @0619fab0
  Type: variable definition analyzed
  Visibility: prevailing_def_ironly
  References: 
